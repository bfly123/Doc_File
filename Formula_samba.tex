...
能量方程：
\begin{equation}
 \rho \frac{de}{dt}= \bm{\sigma} \cdot \bm{\varepsilon}
\end{equation}
...
\begin{equation}
  \left(
  \begin{array}{lll}
	\varepsilon_\alpha & \frac{1}{2}\theta_\gamma & \frac{1}{2}\theta_\beta \\
	\frac{1}{2}\theta _\gamma & \varepsilon_\beta & \frac{1}{2}\theta_\alpha\\
	\frac{1}{2}\theta _\beta & \frac{1}{2} \theta_\alpha & \varepsilon_\gamma\\
	\end{array}
\right)
\end{equation}
其中
\begin{equation}
  \begin{aligned}
  \varepsilon_\alpha = & \frac{1}{h_\alpha} \frac{\partial u_\alpha}{\partial \xi_\alpha} + \frac{u_\beta}{h_\alpha h_\beta} \frac{\partial h_\alpha}{\partial \xi_\beta} + \frac{u_\gamma}{h_\alpha h_\gamma} \frac{\partial h_\alpha}{ \partial \xi_\gamma}\\
  \varepsilon_\beta = & \frac{u_\alpha}{h_\beta h_\alpha} \frac{\partial h_\beta}{\partial \xi_\alpha} + \frac{1}{h_\beta} \frac{\partial u_\beta}{\partial \xi_\beta} + \frac{u_\gamma}{h_\beta h_\gamma} \frac{\partial h_\beta}{ \partial \xi_\gamma}\\
  \varepsilon_\beta = & \frac{u_\alpha}{h_\gamma h_\alpha} \frac{\partial h_\gamma}{\partial \xi_\alpha} + \frac{u_\beta}{h_\gamma h_\beta} \frac{\partial h_\gamma}{\partial \xi_\beta} + \frac{1}{h_\gamma} \frac{\partial u_\gamma}{ \partial \xi_\gamma}\\
\theta_\alpha = & \frac{h_\gamma}{h_\beta} \frac{\partial}{\partial \xi_\beta}\frac{u_\gamma}{h_\gamma} + \frac{h_\beta}{h_\gamma} \frac{\partial}{\partial \xi_\gamma}\frac{u_\beta}{h_\beta}\\
\theta_\beta = & \frac{h_\alpha}{h_\beta} \frac{\partial}{\partial \xi_\gamma}\frac{u_\alpha}{h_\alpha} + \frac{h_\gamma}{h_\alpha} \frac{\partial}{\partial \xi_\alpha}\frac{u_\gamma}{h_\gamma}\\
\theta_\gamma = & \frac{h_\beta}{h_\alpha} \frac{\partial}{\partial \xi_\alpha}\frac{u_\beta}{h_\beta} + \frac{h_\alpha}{h_\beta} \frac{\partial}{\partial \xi_\beta}\frac{u_\alpha}{h_\alpha}\\
\end{aligned}
\end{equation}

	在柱坐标系下
	\begin{equation}
	  \xi_\alpha = x , \hspace{0.3cm} \xi_\beta = r = \sqrt{y^2+z^2},  \hspace{0.3cm}  \xi_\gamma = \psi = \text{arctg} \frac{z}{y} 
	  \end{equation}

	  Lame 系数为
	  \begin{equation}
		h_x=1, \hspace{0.3cm} h_r=1,\hspace{0.3cm} h_\psi = r
	\end{equation}

	根据公式 (\ref{eq:39},\ref{eq:40},\ref{eq:41}) 可以得到柱坐标系下的梯度散度和旋度
\begin{equation}
  \nabla \phi = \frac{\partial \phi}{\partial x} \bm{j}_x +\frac{\partial \phi}{\partial r}\bm{j}_r +\frac{1}{r}\frac{\partial \phi}{\partial \psi}\bm{j}_\psi
  \end{equation}

\begin{equation}
	  \nabla \times \bm{f} =\frac{1}{r} \left[\frac{\partial ( rf_\psi)}{\partial r}-\frac{\partial f_r}{\partial \psi} \right]\bm{j}_x 
	+ \frac{1}{r} \left[\frac{\partial f_x}{\partial \psi}- \frac{\partial r f_\psi  }{\partial x} \right]\bm{j}_r
+ \left[\frac{\partial f_r}{\partial x}- \frac{\partial f_x }{\partial r} \right]\bm{j}_\psi
\end{equation}
\begin{equation}
  \begin{aligned}
  \nabla \cdot \bm{f} =&\frac{1}{r}\left[\frac{\partial}{\partial x}(rf_x) +\frac{\partial}{\partial r}(rf_r) +\frac{\partial}{\partial \psi}(f_\psi)\right]\\
  =& \frac{\partial f_x}{\partial x} +\frac{1}{r}\frac{\partial}{\partial r}(rf_r) +\frac{1}{r}\frac{\partial f_\psi}{\partial \psi}
  \end{aligned}
\end{equation}
...
\begin{equation}
  \begin{aligned}
  & (\nabla \cdot T)_x=  \frac{\partial T_{xx}}{\partial x} +\frac{1}{r}\frac{\partial}{\partial r}(rT_{rx}) +\frac{1}{r}\frac{\partial T_{\psi x}}{\partial \psi}\\
  & (\nabla \cdot T)_r=  \frac{\partial T_{xr}}{\partial x} +\frac{1}{r}\frac{\partial}{\partial r}(rT_{rr}) +\frac{1}{r}\frac{\partial T_{\psi r}}{\partial \psi} - \frac{T_{\psi \psi}}{r}\\
  & (\nabla \cdot T)_\psi=  \frac{\partial T_{x\psi}}{\partial x} +\frac{1}{r}\frac{\partial}{\partial r}(rT_{r\psi}) +\frac{1}{r}\frac{\partial T_{\psi \psi}}{\partial \psi} + \frac{T_{\psi r}}{r}
  \end{aligned}
  \end{equation}
...
\begin{equation}
  \begin{aligned}
  & \varepsilon_x =\frac{\partial u_x}{\partial x}, \hspace{0.3cm} \varepsilon_r = \frac{\partial u_r}{\partial r}, \hspace{0.3cm} \varepsilon_\gamma =\frac{1}{r} \frac{\partial u_\psi}{\partial \psi} +\frac{u_r}{r}\\
  & \theta _x = r\frac{\partial}{\partial r}\left(\frac{u_\psi}{r}\right) + \frac{1}{r} \frac{\partial u_r}{\partial \psi} , \hspace{0.3cm} \theta_r = \frac{1}{r} \frac{\partial u_x}{\partial \psi} + \frac{\partial u_\psi}{\partial x}, \hspace{0.3cm} \theta_\psi = \frac{\partial u_r}{\partial x} + \frac{\partial u_x}{\partial r}
  \end{aligned}
  \end{equation}
...
\begin{equation}
  \begin{aligned}
	&\rho \frac{du}{dt}=\frac{\partial \sigma_{xx}}{ \partial x}  + \frac{1}{r} \frac{\partial (rs_{xr})}{\partial r}\\
	&\rho \frac{dv}{dt}=\frac{\partial s_{xr}}{ \partial x}  + \frac{1}{r} \frac{\partial (r \sigma_{rr})}{\partial r}
	\end{aligned}
  \end{equation}
二维柱坐标下能量方程：
\begin{equation}
  \begin{aligned}
 \rho \frac{de}{dt}= & \bm{\sigma} \cdot \bm{\varepsilon}\\
 = &  \sigma_{xx} \varepsilon_{xx} + \sigma_{rr} \varepsilon_{rr} + 2 \sigma_{xr} \theta_{xr}\\
 = & \sigma_{xx} \frac{\partial u_x}{\partial x}+ \sigma_{rr} \frac{\partial u_r}{\partial r} + \sigma_{xr}\left(  \frac{\partial u_r}{\partial x} +\frac{\partial u_x}{\partial r}\right)
 \end{aligned}
 \end{equation}
...
该公式和所用坐标系无关。
  ...
  \begin{equation}\label{eq:45}
	\begin{aligned}
	d\phi =&\frac{\partial \phi}{\partial \xi_\alpha} d\xi_\alpha +\frac{\partial \phi}{\partial \xi_\beta} d\xi_\beta+\frac{\partial \phi}{\partial \xi_\gamma} d\xi_\gamma\\
	d\bm{r}=&\frac{\partial \bm{r}}{\partial \xi_\alpha} d\xi_\alpha +\frac{\partial \bm{r}}{\partial \xi_\beta} d\xi_\beta+\frac{\partial \bm{r}}{\partial \xi_\gamma} d\xi_\gamma\\
	=&h_\alpha d\xi_\alpha \bm{e}_\alpha + h_\beta d\xi_\beta \bm{e}_\beta+ h_\gamma d\xi_\gamma \bm{e}_\gamma
	\end{aligned}
	\end{equation}
	其中$\bm{e}_\nu$是沿着坐标曲线的单位矢量。 采用待定系数法，令$\nabla f= \lambda_\alpha \bm{e}_\alpha + \lambda_\beta \bm{e}_\beta+ \lambda_\gamma \bm{e}_\gamma$ 代入公式(\ref{eq:41}) 有
\begin{equation}
  \begin{aligned}
 d\phi =&\frac{\partial \phi}{\partial \xi_\alpha} d\xi_\alpha +\frac{\partial \phi}{\partial \xi_\beta} d\xi_\beta+\frac{\partial \phi}{\partial \xi_\gamma} d\xi_\gamma\\
 =& (\lambda_\alpha \bm{e}_\alpha + \lambda_\beta \bm{e}_\beta+ \lambda_\gamma \bm{e}_\gamma)\cdot (
h_\alpha d\xi_\alpha \bm{e}_\alpha + h_\beta d\xi_\beta \bm{e}_\beta+ h_\gamma d\xi_\gamma \bm{e}_\gamma)\\
 =& \lambda_\alpha  h _\alpha d \xi_\alpha+ \lambda_\beta  h_\beta  d\xi_\beta+ \lambda_\gamma  h_\gamma d\xi_\gamma
 \end{aligned}
 \end{equation}
 根据公式 (\ref{eq:45}) 有
 \begin{equation}
   \begin{array}{lll}
\displaystyle 	 \lambda_\alpha =\frac{1}{h_\alpha}\frac{\partial \phi}{\partial \xi_\alpha},&
	 \displaystyle \lambda_\beta =\frac{1}{h_\beta}\frac{\partial \phi}{\partial \xi_\beta},&
	 \displaystyle \lambda_\gamma =\frac{1}{h_\gamma}\frac{\partial \phi}{\partial \xi_\gamma}
	 \end{array}
	 \end{equation}

	 \subsection{一般曲线坐标系下散度公式}
	 \subsubsection{单位矢量的旋度}
单位矢量的旋度
\begin{equation}
  \nabla \xi_\nu =(\frac{1}{h_\alpha}\frac{\partial }{\partial \xi_\alpha}\bm{e}_\alpha+\frac{1}{h_\beta}\frac{\partial }{\partial \xi_\beta}\bm{e}_\beta+\frac{1}{h_\gamma}\frac{\partial }{\partial \xi_\gamma} \bm{e}_\gamma)\xi_\nu =\frac{1}{h_\nu} \bm{e}_\nu
  \end{equation}
  因此有
\begin{equation}
  \nabla \times \left(\frac{1}{h_\nu}\bm{e}_\nu\right) = \nabla \times \nabla \xi_\nu = 0
  \end{equation}
  即矢量$\frac{1}{h_\nu}\bm{e}_\nu$有零旋度。

	 \subsubsection{单位矢量的散度}
	 由于三个单位矢量$\bm{e}_\nu$两两相交，有$\bm{e}_\alpha = \bm{e}_\beta \times \bm{e}_\gamma$，因此
\begin{equation}
  \frac{1}{h_\beta h_\gamma} \bm{e}_\alpha     = \left(\frac{1}{h_\beta} \bm{e}_\beta\right)\times \left(\frac{1}{h_\gamma}\bm{e}_\gamma\right) = \nabla \xi_\beta \times \nabla \xi_\gamma
  \end{equation}
  有
  \begin{equation}
	\nabla \cdot \frac{1}{h_\beta h_\gamma} \bm{e}_\alpha = \nabla \cdot (\nabla \xi_\beta \times \nabla \xi_\gamma) = \nabla \xi_\beta \cdot (\nabla \times \nabla \xi_\gamma) - \nabla \xi_\gamma \cdot (\nabla \times \nabla \xi_\beta) =0
	\end{equation}
	因此矢量$\frac{1}{ h_\beta h_\gamma}\bm{e}_\alpha$的散度为零。

	\subsection{曲线坐标系下的散度公式}
	令$\bm{F} =F_\alpha \bm{e}_\alpha +F_\beta \bm{e}_\beta +F_\gamma \bm{e}_\gamma$
	则$\nabla \cdot \bm{F} = \nabla \cdot  (F_\alpha \bm{e}_\alpha)+\nabla \cdot (F_\beta \bm{e}_\beta) +\nabla \cdot (F_\gamma \bm{e}_\gamma)$

	对于上式第一项
	\begin{equation} 
	  \nabla \cdot (F _\alpha \bm{e}_\alpha)= \nabla \cdot \left(h_\beta h_\gamma F_\alpha \frac{\bm{e}_\alpha}{h_\beta h_\gamma}\right) = \frac{\bm{e} _\alpha}{h_\beta h_\gamma} \cdot \nabla (h_\beta h_\gamma F_\alpha) + h_\beta h_\gamma F_\alpha \nabla \cdot \frac{\bm{e}_\alpha}{h_\beta h_\gamma}
	\end{equation}
	由于$\frac{\bm{e}_\alpha }{h_\beta h_\gamma}$有零散度

\begin{equation}
  \begin{aligned}
	  \nabla \cdot (F _\alpha \bm{e}_\alpha)= & \frac{\bm{e} _\alpha}{h_\beta h_\gamma} \cdot \nabla (h_\beta h_\gamma F_\alpha)\\
	  =&  \frac{\bm{e}_\alpha}{h_\beta h_\gamma} \cdot \left( \frac{1}{h_\alpha} \frac{\partial}{\partial \xi_\alpha}\bm{e}_\alpha + \frac{1}{h_\beta} \frac{\partial}{\partial \xi_\beta}\bm{e}_\beta +\frac{1}{h_\gamma} \frac{\partial}{\partial \xi_\gamma}\bm{e}_\gamma \right) h_\beta h_\gamma F_\alpha \\
	  =& \frac{1}{h_\alpha h_\beta h_\gamma}\frac{\partial h_\beta h_\gamma F_\alpha}{\partial \xi_\alpha}
	\end{aligned}
	\end{equation}
同理可得
\begin{equation}
 \nabla \cdot (F _\beta \bm{e}_\beta)=
	   \frac{1}{h_\alpha h_\beta h_\gamma}\frac{\partial h_\alpha h_\gamma F_\beta}{\partial \xi_\beta}
	   \end{equation}
\begin{equation}
 \nabla \cdot (F _\gamma \bm{e}_\gamma)=
	   \frac{1}{h_\alpha h_\beta h_\gamma}\frac{\partial h_\alpha h_\beta F_\gamma}{\partial \xi_\gamma}
	   \end{equation}
	   因此可得散度表达式
\begin{equation}
  \nabla \cdot \bm{F} =\frac{1}{h_\alpha h_\beta h_\gamma} \left( \frac{\partial h_\beta h_\gamma F_\alpha}{\partial \xi_\alpha}+ \frac{\partial h_\alpha h_\gamma F_\beta}{\partial \xi_\beta}+ \frac{\partial h_\alpha h_\beta F_\gamma}{\partial \xi_\gamma}
	 \right)
	  \end{equation}
	  \subsection{旋度公式}
	令$\bm{F} =F_\alpha \bm{e}_\alpha +F_\beta \bm{e}_\beta +F_\gamma \bm{e}_\gamma$
	则$\nabla \times \bm{F} = \nabla \times  (F_\alpha \bm{e}_\alpha)+\nabla \times (F_\beta \bm{e}_\beta) +\nabla \times (F_\gamma \bm{e}_\gamma)$
	右端第一项
	\begin{equation}
	  \begin{aligned}
	\nabla \times (F_\alpha \bm{e}_\alpha) =& \nabla (h_\alpha F_\alpha) \times \frac{\bm{e}_\alpha}{h_\alpha}+F_\alpha h_\alpha \nabla \times \frac{\bm{e}_\alpha}{h_\alpha} \\
	=& \left(\frac{1}{h_\alpha} \frac{\partial}{\partial \xi_\alpha} \bm{e}_\alpha +
	\frac{1}{h_\beta} \frac{\partial}{\partial \xi_\beta} \bm{e}_\beta+\frac{1}{h_\gamma} \frac{\partial}{\partial \xi_\gamma} \bm{e}_\gamma\right) h_\alpha F_\alpha \times \frac{1}{h_\alpha}\bm{e}_\alpha +0 \\
	=& \frac{1}{h_\alpha h_\beta} \frac{\partial h_\alpha F_\alpha }{\partial \xi_\beta} (-\bm{e}_\gamma) +\frac{1}{h_\alpha h_\gamma}\frac{\partial  h_\alpha F_\alpha}{\partial \xi_\gamma}(\bm{e}_\beta)\\
	=& \frac{1}{h_\alpha h_\beta  h_\gamma} \left[\frac{\partial  h_\alpha F_\alpha}{\partial \xi_\gamma}( h_\beta \bm{e}_\beta)- \frac{\partial h_\alpha F_\alpha }{\partial \xi_\beta}  (h_\gamma \bm{e}_\gamma) \right]
	\end{aligned}
	\end{equation}
	同理可得 
	\begin{equation}
	  \begin{aligned}
	  &\nabla \times (F_\beta \bm{e}_\beta) = \frac{1}{h_\alpha h_\beta h_\gamma}\left[ \frac{\partial h_\beta F_\beta}{\partial \xi_\alpha}(h_\gamma \bm{e}_\gamma)- \frac{\partial h_\beta F_\beta}{\partial \xi_\gamma}(h_\alpha \bm{e}_\alpha)\right]\\
	  &\nabla \times (F_\gamma \bm{e}_\gamma) = \frac{1}{h_\alpha h_\beta h_\gamma}\left[ \frac{\partial h_\gamma F_\gamma}{\partial \xi_\beta}(h_\alpha \bm{e}_\alpha)- \frac{\partial h_\gamma F_\gamma}{\partial \xi_\alpha}(h_\beta \bm{e}_\beta)\right]\\
	  \end{aligned}
	  \end{equation}
可以写成简化形式
	  \begin{equation}
		\nabla \times \bm{F} =\frac{1}{h_\alpha h_\beta h_\gamma} 
 \left| 
 \begin{array}{lll}
   h_\alpha \bm{e}_\alpha & h_\beta \bm{e}_\beta & h_\gamma \bm{e}_\gamma\\
    \frac{\partial}{\partial \xi_\alpha}& \frac{\partial}{\partial \xi_\beta}& \frac{\partial}{\partial \xi_\gamma}\\
   h_\alpha F_\alpha & h_\beta F_\beta & h_\gamma F_\gamma\\
   \end{array}
 \right|
 \end{equation}
