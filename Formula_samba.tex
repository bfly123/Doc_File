...
该格式同样可以通过有限元方法得出(Lascaux 1973年）\cite{lascauxapplication}。控制体同样取如图\ref{fig:1}，以$I$区为例，在该区通过虚功原理，可以化作有限元的单元积分：
...
\begin{equation}
  ...
  & +\frac{1}{2}(u_3+u_4)(z_4-z_3)+\frac{1}{2}(u_4+u_1)(u_1-u_4))\\
